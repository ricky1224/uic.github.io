            ...
            <div class="main_menu">
            	<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="Default.aspx"><img src="img/logo.png" alt=""></a>
							...
							<ul class="nav navbar-nav menu_nav ml-auto">
								...
								<li class="nav-item submenu dropdown active">
									...
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="courses.aspx">Courses</a>
										<li class="nav-item"><a class="nav-link" href="course-details.aspx">Course Details</a></li>
									</ul>
								</li> 
				...
				<div class="container">
					<div class="banner_content text-center">
						...
						<div class="page_link">
							...
							<a href="courses.aspx">Course</a>
							<a href="course-details.aspx">Course Details</a>
						</div>
					</div>
				</div>
            </div>
